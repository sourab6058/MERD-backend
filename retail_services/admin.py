...
class CategoryExpenseAdmin(ImportExportModelAdmin):
    list_display = ('id', 'category_expense', 'monthly_income', 'year', 'month','nationality','category','zone')

admin.site.register(CategoryExpense, CategoryExpenseAdmin)

class HouseholdAdmin(ImportExportModelAdmin):
    list_display = ('id', 'zone','city', 'population', 'household_number', 'year')
...
class SubCategoryExpenseAdmin(ImportExportModelAdmin):
    list_display = ('id', 'subcategory_expense', 'monthly_income', 'year', 'month','nationality','sub_category')
...
class SubSubCategoryExpenseAdmin(admin.ModelAdmin):
    list_display = ('id', 'subsubcategory_expense', 'monthly_income', 'year', 'month','nationality','sub_sub_category')
